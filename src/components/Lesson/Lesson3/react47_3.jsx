...
import term from '../../../asset3/Misc/เสี่ยง3.png';


const App = () => {
  const [showNextButton, setShowNextButton] = useState(false);
      useEffect(() => {
      document.body.className = 'page-bg473';
    ...
    useEffect(() => {
      ...
      const updated = Array.from(new Set([...visited, "p47_3"]));
      localStorage.setItem("visitedPages", JSON.stringify(updated));
    }, []);

    useEffect(() => {
  localStorage.setItem("visited_p47_3", "true");
      const visitedAll = 
  ...
  return (
    <div>
      ...
      <Link className="btnback473" to="/p47_2" data-discover="true">ย้อนกลับ</Link>
      <div className="center473">
        <h2>
      ...
      <div className="carder473">
        <img className="buntookbon473" src={buntookbon} />
      </div>
      <div className="left-triangle473"></div>
      <div className="right-triangle473"></div>
      <div className="bottom-triangle473"></div>
      <div className="top-square473"></div>
